...
urlpatterns = [
    ...
    path('<company_name>/products/<product_name>/prices', views.getCompanyProductByName, name='getCompanyProductByName'),
    path('<company_name>/products/<product_name>/best', views.getCompanyProductBestPrice, name='getCompanyProductBestPrice'),
